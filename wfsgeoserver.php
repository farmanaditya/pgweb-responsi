...
$wfsUrl =
    file_get_contents("http://localhost:8080/geoserver/sejarah_solo/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=sejarah_solo%3Aadmin&maxFeatures=50&outputFormat=application%2Fjson");
